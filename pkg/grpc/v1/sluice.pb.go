...
func (x *DeleteAllTenantsRequest) Reset() {
	*x = DeleteAllTenantsRequest{}
	mi := &file_sluice_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAllTenantsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAllTenantsRequest) ProtoMessage() {}

func (x *DeleteAllTenantsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sluice_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAllTenantsRequest.ProtoReflect.Descriptor instead.
func (*DeleteAllTenantsRequest) Descriptor() ([]byte, []int) {
	return file_sluice_proto_rawDescGZIP(), []int{11}
}

type DeleteAllTenantsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DeleteAllTenantsResponse) Reset() {
	*x = DeleteAllTenantsResponse{}
	mi := &file_sluice_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAllTenantsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAllTenantsResponse) ProtoMessage() {}

func (x *DeleteAllTenantsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sluice_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAllTenantsResponse.ProtoReflect.Descriptor instead.
func (*DeleteAllTenantsResponse) Descriptor() ([]byte, []int) {
	return file_sluice_proto_rawDescGZIP(), []int{12}
}

func (x *DeleteAllTenantsResponse) GetDeleted() int32 {
	if x != nil {
		return x.Deleted
	}
	return 0
...
func (x *HealthRequest) Reset() {
	*x = HealthRequest{}
	mi := &file_sluice_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return file_sluice_proto_rawDescGZIP(), []int{21}
}
...
func (x *HealthResponse) Reset() {
	*x = HealthResponse{}
	mi := &file_sluice_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return file_sluice_proto_rawDescGZIP(), []int{22}
}
...
const file_sluice_proto_rawDesc = "" +
	...
	"\x17DeleteAllTenantsRequest\"4\n" +
	"\x18DeleteAllTenantsResponse\x12\x18\n" +
	"\adeleted\x18\x01 \x01(\x05R\adeleted\"\x14\n" +
	...
	"\x06leader\x18\x03 \x01(\tR\x06leader2\xf1\x05\n" +
	"\x06Sluice\x12=\n" +
	...
	"\fDeleteTenant\x12\x1e.sluice.v1.DeleteTenantRequest\x1a\x1f.sluice.v1.DeleteTenantResponse\x12[\n" +
	"\x10DeleteAllTenants\x12\".sluice.v1.DeleteAllTenantsRequest\x1a#.sluice.v1.DeleteAllTenantsResponse\x12L\n" +
...
var file_sluice_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_sluice_proto_goTypes = []any{
	...
	(*DeleteAllTenantsRequest)(nil),  // 11: sluice.v1.DeleteAllTenantsRequest
	(*DeleteAllTenantsResponse)(nil), // 12: sluice.v1.DeleteAllTenantsResponse
	(*ListTenantsRequest)(nil),       // 13: sluice.v1.ListTenantsRequest
	(*TenantInfo)(nil),               // 14: sluice.v1.TenantInfo
	(*ListTenantsResponse)(nil),      // 15: sluice.v1.ListTenantsResponse
	(*ClusterStatusRequest)(nil),     // 16: sluice.v1.ClusterStatusRequest
	(*NodeInfo)(nil),                 // 17: sluice.v1.NodeInfo
	(*TenantAllocation)(nil),         // 18: sluice.v1.TenantAllocation
	(*NodeAllocation)(nil),           // 19: sluice.v1.NodeAllocation
	(*ClusterStatusResponse)(nil),    // 20: sluice.v1.ClusterStatusResponse
	(*HealthRequest)(nil),            // 21: sluice.v1.HealthRequest
	(*HealthResponse)(nil),           // 22: sluice.v1.HealthResponse
}
var file_sluice_proto_depIdxs = []int32{
	...
	14, // 2: sluice.v1.ListTenantsResponse.tenants:type_name -> sluice.v1.TenantInfo
	18, // 3: sluice.v1.NodeAllocation.tenants:type_name -> sluice.v1.TenantAllocation
	17, // 4: sluice.v1.ClusterStatusResponse.nodes:type_name -> sluice.v1.NodeInfo
	19, // 5: sluice.v1.ClusterStatusResponse.allocations:type_name -> sluice.v1.NodeAllocation
	...
	11, // 12: sluice.v1.Sluice.DeleteAllTenants:input_type -> sluice.v1.DeleteAllTenantsRequest
	13, // 13: sluice.v1.Sluice.ListTenants:input_type -> sluice.v1.ListTenantsRequest
	16, // 14: sluice.v1.Sluice.ClusterStatus:input_type -> sluice.v1.ClusterStatusRequest
	21, // 15: sluice.v1.Sluice.Health:input_type -> sluice.v1.HealthRequest
	1,  // 16: sluice.v1.Sluice.Submit:output_type -> sluice.v1.SubmitResponse
	3,  // 17: sluice.v1.Sluice.SubmitBatch:output_type -> sluice.v1.SubmitBatchResponse
	5,  // 18: sluice.v1.Sluice.GetTask:output_type -> sluice.v1.TaskStatus
	5,  // 19: sluice.v1.Sluice.WaitTask:output_type -> sluice.v1.TaskStatus
	8,  // 20: sluice.v1.Sluice.UpsertTenant:output_type -> sluice.v1.UpsertTenantResponse
	10, // 21: sluice.v1.Sluice.DeleteTenant:output_type -> sluice.v1.DeleteTenantResponse
	12, // 22: sluice.v1.Sluice.DeleteAllTenants:output_type -> sluice.v1.DeleteAllTenantsResponse
	15, // 23: sluice.v1.Sluice.ListTenants:output_type -> sluice.v1.ListTenantsResponse
	20, // 24: sluice.v1.Sluice.ClusterStatus:output_type -> sluice.v1.ClusterStatusResponse
	22, // 25: sluice.v1.Sluice.Health:output_type -> sluice.v1.HealthResponse
