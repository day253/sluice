...
func (c *Collector) collect() {
	...
	c.ensure("performance:scheduler:submission-batches", nil).Record(int64(scheduler.SubmissionBatches))
	c.ensure("performance:scheduler:submission-requests", nil).Record(int64(scheduler.SubmissionRequests))
	c.ensure("performance:scheduler:submission-tasks", nil).Record(int64(scheduler.SubmissionTasks))
	c.ensure("performance:scheduler:submission-queue-us", nil).Record(divideInt64(scheduler.TotalSubmissionWaitUS, scheduler.SubmissionBatches))
	c.ensure("performance:scheduler:submission-queue-max-us", nil).Record(scheduler.MaxSubmissionWaitUS)
	c.ensure("performance:scheduler:submission-queue-depth", nil).Record(scheduler.SubmissionQueueDepth)
	c.ensure("performance:scheduler:submission-backpressure-waits", nil).Record(int64(scheduler.SubmissionBackpressureWaits))
	c.ensure("performance:scheduler:submission-backpressure-rejections", nil).Record(int64(scheduler.SubmissionBackpressureRejections))
	c.ensure("performance:scheduler:submission-backpressure-us", nil).Record(divideInt64(scheduler.TotalSubmissionBackpressureUS, scheduler.SubmissionBackpressureWaits))
	c.ensure("performance:scheduler:submission-backpressure-max-us", nil).Record(scheduler.MaxSubmissionBackpressureUS)
	c.ensure("performance:scheduler:submission-apply-inflight", nil).Record(scheduler.SubmissionApplyInFlight)
	c.ensure("performance:scheduler:submission-apply-waiting", nil).Record(scheduler.SubmissionApplyWaiting)
	c.ensure("performance:scheduler:submission-apply-limit", nil).Record(scheduler.SubmissionApplyLimit)
